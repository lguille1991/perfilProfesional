         ...
         <div class="container-fluid">
            ...
            <div class="row main">
                ...
                <div class="main-login main-center">
                    ...
                    <form class="" method="post" action="procesarIdioma">
                        ...
                        <div class="form-group">
                            <label for="name" class="cols-sm-2 control-label">Nombre del idioma</label>
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-file" aria-hidden="true"></i></span>
                                    <input type="text" class="form-control" name="txtNombreIdioma" id="txtNombreIdioma"  placeholder="Ingrese el nombre del idioma"/>
                                </div>
                            </div>
                        </div>
